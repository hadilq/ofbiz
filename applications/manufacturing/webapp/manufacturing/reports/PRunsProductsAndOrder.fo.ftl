              ...
              <fo:table-column column-width="2.00cm"/>
                <fo:table-body>
                    <fo:table-row>
                        ...
                        <fo:table-cell>
                            <fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always" text-align="start">
                                <fo:inline font-size="9pt">${uiLabelMap.ManufacturingPrintoutDate} : ${Static["org.ofbiz.base.util.UtilDateTime"].nowDateStringByContext(context)}</fo:inline>
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell>
                            <fo:block line-height="12pt" space-before.optimum="1.5pt" space-after.optimum="1.5pt" keep-together="always" text-align="start">
                                <fo:inline font-size="9pt">${uiLabelMap.ManufacturingCompletionDate} : ${Static["org.ofbiz.base.util.UtilDateTime"].toDateStringByContext(productionRun.productionRun.estimatedCompletionDate, context)}</fo:inline>
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell>
                        </fo:table-cell>
