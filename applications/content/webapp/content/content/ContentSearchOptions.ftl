  ...
  <div class="screenlet-body">
    <form name="advToKeyWordSearchForm" method="post" action="<@ofbizUrl>ContentSearchResults</@ofbizUrl>" style="margin: 0;">
      ...
      <table class="basic-table" cellspacing="0">
        <tr>
          <td class="opposite-align-text" valign="middle" class="label">${uiLabelMap.ContentKeywords}</td>
          <td valign="middle">
            <div>
        ...
        <tr>
          <td class="opposite-align-text" valign="middle" class="label">${uiLabelMap.FormFieldTitle_contentId}</td>
          <td valign="middle">
            <div>
        ...
        <tr>
          <td class="opposite-align-text" valign="middle" nowrap="nowrap" class="label">${uiLabelMap.FormFieldTitle_contentAssocTypeId}</td>
        ...
        <tr>
          <td width='25%' class="opposite-align-text" class='label'>${uiLabelMap.ContentLastUpdatedDateFilter}</td>
          <td>
            <table class="basic-table" cellspacing="0">
               <tr>
                  <td nowrap="nowrap">
