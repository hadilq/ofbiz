...
<#if !paymentMethod?has_content>
  ...
  <tr>
    <td width="26%" class="opposite-align-text" valign="middle"><b>${uiLabelMap.AccountingCompanyNameCard}</b></td>
    <td width="5">&nbsp;</td>
    <td width="74%">
  ...
  <tr>
    <td width="26%" class="opposite-align-text" valign="middle"><b>${uiLabelMap.AccountingPrefixCard}</b></td>
    <td width="5">&nbsp;</td>
    <td width="74%">
  ...
  <tr>
    <td width="26%" class="opposite-align-text" valign="middle"><b>${uiLabelMap.AccountingFirstNameCard}</b></td>
    <td width="5">&nbsp;</td>
    <td width="74%">
  ...
  <tr>
    <td width="26%" class="opposite-align-text" valign="middle"><b>${uiLabelMap.AccountingMiddleNameCard}</b></td>
    <td width="5">&nbsp;</td>
    <td width="74%">
  ...
  <tr>
    <td width="26%" class="opposite-align-text" valign="middle"><b>${uiLabelMap.AccountingLastNameCard}</b></td>
    <td width="5">&nbsp;</td>
    <td width="74%">
  ...
  <tr>
    <td width="26%" class="opposite-align-text" valign="middle"><b>${uiLabelMap.AccountingSuffixCard}</b></td>
    <td width="5">&nbsp;</td>
    <td width="74%">
  ...
  <tr>
    <td width="26%" class="opposite-align-text" valign="middle"><b>${uiLabelMap.AccountingCardType}</b></td>
    <td width="5">&nbsp;</td>
    <td width="74%">
  ...
  <tr>
    <td width="26%" class="opposite-align-text" valign="middle"><b>${uiLabelMap.AccountingCardNumber}</b></td>
    <td width="5">&nbsp;</td>
    <td width="74%">
        <#if creditCard?has_content>
  ...
  <#--<tr>
    <td width="26%" class="opposite-align-text" valign="middle">${uiLabelMap.AccountingCardSecurityCode}</td>
    <td width="5">&nbsp;</td>
    <td width="74%">
  ...
  <tr>
    <td width="26%" class="opposite-align-text" valign="middle"><b>${uiLabelMap.AccountingExpirationDate}</b></td>
    <td width="5">&nbsp;</td>
    <td width="74%">
      <#assign expMonth = "">
      <#assign expYear = "">
  ...
  <tr>
    <td width="26%" class="opposite-align-text" valign="middle"><b>${uiLabelMap.CommonDescription}</b></td>
    <td width="5">&nbsp;</td>
    <td width="74%">
