                ...
                <td>
                  ...
                  <#list curPartyContactMechPurposes as curPartyContactMechPurpose>
                    ...
                    <#if curPartyContactMechPurpose.thruDate?exists>
                      <p>(${uiLabelMap.CommonExpire}:${Static["org.ofbiz.base.util.UtilDateTime"].toDateTimeFormat(context).format(curPartyContactMechPurpose.thruDate)})</p>
                    </#if>
                  </#list>
                  ...
                  <p>(${uiLabelMap.CommonUpdated}:&nbsp;${(Static["org.ofbiz.base.util.UtilDateTime"].toDateTimeFormat(context).format(curPartyContactMech.fromDate))?if_exists})</p>
                  <#if curPartyContactMech.thruDate?exists><p><b>${uiLabelMap.CommonDelete}:&nbsp;${Static["org.ofbiz.base.util.UtilDateTime"].toDateTimeFormat(context).format(curPartyContactMech.thruDate)}</b></p></#if>
                </td>
              </tr>
            <#else>
               <#-- <tr>
              ...
              <#list postalAddressInfos as postalAddressInfo>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>(${uiLabelMap.CommonUpdated}:&nbsp;${(Static["org.ofbiz.base.util.UtilDateTime"].toDateTimeFormat(context).format(partyContactMech.fromDate))?if_exists})</p>
                    <#if partyContactMech.thruDate?exists><p><b>${uiLabelMap.CommonDelete}:&nbsp;${Static["org.ofbiz.base.util.UtilDateTime"].toDateTimeFormat(context).format(partyContactMech.thruDate)}</b></p></#if>
                  </td>
                </tr>
              </#list>
