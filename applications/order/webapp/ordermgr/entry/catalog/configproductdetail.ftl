  ...
  <tr>
    <td valign="top" width="0">
      ...
      <#if productLargeImageUrl?string?has_content>
        <a href="javascript:popupDetail();"><img src='<@ofbizContentUrl>${contentPathPrefix?if_exists}${productLargeImageUrl?if_exists}</@ofbizContentUrl>' name='mainImage' vspace='5' hspace='5' class='cssImgLarge' class="align-text" alt="" /></a>
      </#if>
    </td>
            ...
            <td>
              ...
              <#if question.isFirst()>
                ...
                <#if image?has_content>
                  <img src='<@ofbizContentUrl>${contentPathPrefix?if_exists}${image?if_exists}</@ofbizContentUrl>' vspace='5' hspace='5' class='cssImgSmall' class="align-text" alt="" />
                </#if>
              <#else>
