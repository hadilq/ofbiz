...
<tr>
  <td width="26%" class="opposite-align-text" valign="middle"><div>${uiLabelMap.PartyToName}</div></td>
  <td width="5">&nbsp;</td>
  <td width="74%">
...
<tr>
  <td width="26%" class="opposite-align-text" valign="middle"><div>${uiLabelMap.PartyAttentionName}</div></td>
  <td width="5">&nbsp;</td>
  <td width="74%">
...
<tr>
  <td width="26%" class="opposite-align-text" valign="middle"><div>${uiLabelMap.PartyAllowSolicitation}?</div></td>
  <td width="5">&nbsp;</td>
  <td width="74%">
