     ...
     <tr>
        <td width="50%">
           <table width="100%" border="0" cellpadding="1" cellspacing="0">
              ...
              <tr>
                 <td width="26%" class="opposite-align-text" valign="top"><div class="tableheadtext">${uiLabelMap.PartyNameAndConactInfo}</div></td>
                 <td width="2%">&nbsp;</td>
                 <td width="72%">&nbsp;</td>
              </tr>
              <tr>
              ...
              <tr>
                <td width="10%" class="opposite-align-text"><div>${uiLabelMap.PartyHomePhone}</div></td>
                <td width="2%">&nbsp;</td>
                <td width="88%">
              ...
              <tr>
                <td width="26%" class="opposite-align-text"><div>${uiLabelMap.PartyBusinessPhone}</div></td>
                <td width="2%">&nbsp;</td>
                <td width="72%">
              ...
              <tr>
                <td width="26%" class="opposite-align-text"><div>${uiLabelMap.PartyEmailAddress}</div></td>
                <td width="2%">&nbsp;</td>
                <td width="72%">
     ...
     <tr>
        <td width="50%">
           <table width="100%" border="0" cellpadding="1" cellspacing="0">
              ...
              <tr>
                 <td width="26%" class="opposite-align-text" valign="top"><div class="tableheadtext">${uiLabelMap.OrderShippingAddress}</div></td>
                 <td width="2%">&nbsp;</td>
                 <td width="72%">&nbsp;</td>
              </tr>
              <tr>
                <td width="26%" class="opposite-align-text"><div>${uiLabelMap.PartyToName}</div></td>
                <td width="2%">&nbsp;</td>
                <td width="72%">
              ...
              <tr>
                <td width="26%" class="opposite-align-text"><div>${uiLabelMap.PartyAttentionName}</div></td>
                <td width="2%">&nbsp;</td>
                <td width="72%">
              ...
              <tr>
                 <td width="26%" class="opposite-align-text" valign="middle"><div>${uiLabelMap.PartyAddressLine1}</div></td>
                 <td width="2%">&nbsp;</td>
                 <td width="72%">
              ...
              <tr>
                 <td width="26%" class="opposite-align-text" valign="middle"><div>${uiLabelMap.PartyAddressLine2}</div></td>
                 <td width="2%">&nbsp;</td>
                 <td width="72%">
              ...
              <tr>
                 <td width="26%" class="opposite-align-text" valign="middle"><div>${uiLabelMap.PartyCity}</div></td>
                 <td width="2%">&nbsp;</td>
                 <td width="72%">
              ...
              <tr>
                 <td width="26%" class="opposite-align-text" valign="middle"><div>${uiLabelMap.PartyState}</div></td>
                 <td width="2%">&nbsp;</td>
                 <td width="72%">
              ...
              <tr>
                 <td width="26%" class="opposite-align-text" valign="middle"><div>${uiLabelMap.PartyZipCode}</div></td>
                 <td width="2%">&nbsp;</td>
                 <td width="72%">
              ...
              <tr>
                 <td width="26%" class="opposite-align-text" valign="middle"><div>${uiLabelMap.CommonCountry}</div></td>
                 <td width="2%">&nbsp;</td>
                 <td width="72%">
