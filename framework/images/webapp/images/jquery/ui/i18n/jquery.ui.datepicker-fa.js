...
jQuery(function($) {
	$.datepicker.regional['fa'] = {
		...
		weekHeader: 'هف',
		dateFormat: 'yy/mm/dd',
		numbersCharacters: ["۰","۱","۲","۳","۴","۵","۶","۷","۸","۹"],
		firstDay: 6,
		isRTL: true,
		showMonthAfterYear: false,
        calendar: function(input1, input2, input3) {
            if (input1 != null && input2 != null && input3 != null)
                return new JalaliDate(input1, input2, input3); // input1, input2, input3 are Year, Month, Day
            else if (input1 != null)
                return new JalaliDate(input1); // input1 is milliseconds
            else
